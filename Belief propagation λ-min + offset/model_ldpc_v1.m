...
%        [receivedBits, totalIter] = Belief_propagation_lambda_min_correction(A, decoderInput, L, noisevariance(i), codeRate, Eb, inCheck, inBit, indexLine);
      [receivedBits, totalIter] = Belief_propagation_lambda_min_offset_correction(A, decoderInput, L, noisevariance(i), codeRate, Eb, inCheck, inBit, indexLine);
%        [receivedBits, totalIter] = Belief_propagation_lambda_min_offset_correction(A, decoderInput, L, noisevariance(i), codeRate, Eb, inCheck, inBit, indexLine);
