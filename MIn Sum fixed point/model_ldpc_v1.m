...
indexLine=find(H);
nzero=nnz(H);
% noisevariance=[0.6166  0.6310 0.6607   0.6761  0.6918 0.7079 0.7943 1.0];%[0.001 0.1000 0.1259 0.1585 0.1995 0.2512 0.3162]; %[0.6607 0.4467   0.3981    0.3162    0.2512    0.1995  0.1259];
...
noisevariance=[0.2512 0.316 0.3981 0.5012];%  0.6166  0.6310 0.6607   0.6761  0.6918 0.7079 0.7943 1.0];
...
%         receivedBits = receivedBits(1:324)<=0;                                               %for matlab decoder
